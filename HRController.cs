...
namespace EmployeeLoanManagementSystem.Controllers
{
    ...
    {
        // public int ide;
        SqlConnection conn = new SqlConnection("Data Source=DESKTOP-1PK9LE8\\SKISQL;Initial Catalog=DB7;Integrated Security=True;MultipleActiveResultSets=True;Application Name=EntityFramework");

        DB7Entities5 db = new DB7Entities5();
        // GET: HR
        ...
        {
            EmployeeLoanManagementSystem.Models.DB7Entities5 db = new EmployeeLoanManagementSystem.Models.DB7Entities5();
            //crMVCApp.Models.Employee e
            ReportDocument rd = new ReportDocument();
            //var c = crMVCApp.Models.DB7Entities()
            //ShowPending rpt = new ShowPending();
